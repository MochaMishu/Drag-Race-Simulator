...
let sonique = new Queen("Kylie Sonique Love", 12, 9, 12, 9, 9, 12, 15, "Kylie",false, "US2");
...
let katya = new Queen("Katya", 10, 11, 9, 7, 12, 10, 10, "Katya",false, "US7");
...
let trixie = new Queen("Trixie Mattel", 13, 13, 7, 12, 13, 10, 6, "Trixie",false, "US7");
...
let bob = new Queen("Bob The Drag Queen", 15, 15, 10, 9, 15, 12, 15, "Bob",false, "US8");
...
let monet = new Queen("Monét X Change", 10, 12, 13, 9, 12, 12, 14, "Monet",false, "US10");
...
let rajah = new Queen("Ra'Jah O'Hara", 9, 8, 13, 15, 9, 12, 14, "Rajah",false, "US11");
...
let lemon = new Queen("Lemon", 10, 11, 12, 7, 11, 13, 11, "Lemon",false, "CA1");
